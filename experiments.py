#This code was made by Alexis Rosenfeld for the eperiment conclude in the reinforcemnt leranign course given by prof Dimitrakakis at the neuhcatel university
#Some 
...
#the different model I run in the experiment 
...
ax.plot(
    advanced_gain_history,
    label="Ergonomic + position switch"
)

ax.set_title(
    f"Ergonomic benchmark gain | episodes={EPISODES}"
)
...
#this code is to plot the tree conmaprisn figures 
draw_layout(
    initial_keys,
    naive_keys,
    "Naive utility"
